...
- Most analysis work is stored in Jupyter notebooks.
- Several projects also include exported HTML or PDF reports for easier review.
- Datasets are kept alongside the notebooks when allowed by course or project requirements.
